...
CREATE TABLE public.orders (
                               ...
                               delivery_signature character varying(255),
    ...
    CONSTRAINT orders_priority_check CHECK (((priority)::text = ANY ((ARRAY['NORMALE'::character varying, 'MOYENNE'::character varying, 'HAUTE'::character varying])::text[]))),
...
COPY public.orders (id, billing_address, created_at, delivery_date, discount_amount, discount_rate, expected_delivery_date, internal_notes, notes, order_date, order_number, payment_status, shipping_address, shipping_cost, status, total_amount, total_amount_ht, total_vat_amount, updated_at, client_id, user_id, carrier, confirmed_at, delivered_at, delivery_signature, margin_percentage, priority, shipped_at, tracking_number) FROM stdin;
\.
...
COPY public.users (id, account_non_expired, account_non_locked, created_at, credentials_non_expired, email, enabled, first_name, last_login, last_name, password, personal_target, updated_at, username, phone_number) FROM stdin;
3	t	t	2025-08-04 22:34:09.617667	t	manager2@commercial.com	t	Pierre	\N	Martin	$2a$12$rzpjOtbKaSvDekE17IoT5uP6GayHwvSozxB351Fq8NXFbzY.GDr8C	280000.00	2025-08-04 22:34:09.617667	manager2	\N
4	t	t	2025-08-04 22:34:10.838897	t	marie@commercial.com	t	Marie	\N	Lemoine	$2a$12$caCeOrH2fNrNcx0MQiSYiOZ88nKDmwojTO.5EZtnaFL/ZyeNXA6QO	120000.00	2025-08-04 22:34:10.838897	marie.commercial	\N
5	t	t	2025-08-04 22:34:10.8464	t	paul@commercial.com	t	Paul	\N	Durand	$2a$12$hkTIuMKRbwC//FHcrwspMuyDTor0rvIYkPurgF0Z7wsM18rzgzFcy	110000.00	2025-08-04 22:34:10.8464	paul.commercial	\N
6	t	t	2025-08-04 22:34:10.85041	t	julie@commercial.com	t	Julie	\N	Bernard	$2a$12$Q7GzG8vYq8DIXOdMG9M2S.Mo6WHmyI5nbu9NE42wLxbJ/ytl8TrG2	100000.00	2025-08-04 22:34:10.85041	julie.commercial	\N
7	t	t	2025-08-04 22:34:10.854282	t	antoine@commercial.com	t	Antoine	\N	Rousseau	$2a$12$kVhondTgMQGQOXiGxJyzdeHyh6dUIrJycfvdeBepq1nS7zJ8MnSky	90000.00	2025-08-04 22:34:10.854282	antoine.commercial	\N
9	t	t	2025-08-04 22:34:12.107883	t	emma@commercial.com	t	Emma	\N	Lefebvre	$2a$12$TiHN/wwOgr7o56agz24PJewFYbwNWVxis14GicQRdU5J.LenXPlrK	105000.00	2025-08-04 22:34:12.107883	emma.commercial	\N
10	t	t	2025-08-04 22:34:12.113869	t	thomas@commercial.com	t	Thomas	\N	Roux	$2a$12$QnWPOjMMaozHzgslgAVjy.hqDe0.OGdQjZfF/yb8uf9qJkqZWirvO	95000.00	2025-08-04 22:34:12.113869	thomas.commercial	\N
11	t	t	2025-08-04 22:34:12.118894	t	clara@commercial.com	t	Clara	\N	Fournier	$2a$12$IJnfIRh1MSFI8NywkINUIOTeQ5mIwVbXyuEgJGezAJGHB/QNg4bqa	85000.00	2025-08-04 22:34:12.118894	clara.commercial	\N
8	t	t	2025-08-04 22:34:12.099264	t	lucas@commercial.com	f	Lucas	\N	Moreau	$2a$12$0Zzs1k6sQOg5KYXgN79JEOhkTAFlr8WZ1Rva2GxB6vJN30Pmjn/gG	115000.00	2025-08-07 23:14:05.410759	lucas.commercial	\N
2	t	t	2025-08-04 22:34:08.97601	t	manager1@commercial.com	t	Sophie	2025-08-17 17:58:13.699653	Dubois	$2a$12$FhBhTBvJKD.qq4wIMFbUNeCqHozFOzO5HRWqYzj7//9kagwFEgrNS	300000.00	2025-08-17 17:58:13.699653	manager1	\N
1	t	t	2025-08-04 22:34:08.347499	t	admin@commercial.com	t	Jean	2025-08-22 18:45:59.491053	Administrateur	$2a$12$aV9lU2nA0EORj5KzhuZ4iOHJmIWECi6VQI3DIe/ewuYz3KNwJ0k3u	0.00	2025-08-22 18:45:59.492074	admin	\N
\.
